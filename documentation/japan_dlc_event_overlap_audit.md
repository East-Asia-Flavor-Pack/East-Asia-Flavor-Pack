...
최초 후보 12개 중 **처리 완료 9개, 미처리 3개**다. 완료는 코드 삭제·연결 통합 및 활성 참조 확인 기준이며, 게임 내 연쇄 발생 검증 완료를 뜻하지 않는다. 최초 판정·제안은 비교 이력으로 남기고 현재 상태와 구분했다.

- **처리 완료:** 대교선포, 오시오 반란, 황실 혼인, 피살→배상→포격, 공사관 방화, 모리슨호, 고카쿠 서거, 에도 지진, 홋카이도 개척 완료.
- **미처리:** 쇼군 승계, 천황 승계, 대정봉환·왕정복고·보신전쟁 개시.
...
| 미처리 | 우선 2 | 천황 즉위와 연호 전환 | japan_monarchy.1, japan_monarchy.2, japan_monarchy.3, japan_monarchy.4 | eafp_japan.1010, eafp_japan.1011, eafp_japan.1016, eafp_japan.1017, eafp_japan.1022, eafp_japan.1024 | 고메이·메이지·다이쇼·쇼와 승계를 두 체계가 다룬다. 바닐라 .1은 숨겨진 처리이므로 모든 항목이 이중 팝업인 것은 아니다. | 천황 인물/승계 처리를 통합하고 EAFP는 필요 시 즉위 후 반응만 표시. | 표에 열거한 EAFP 천황 즉위 이벤트가 남아 있으며, 고카쿠 서거 삭제와는 별개임. |
...
1. 쇼군·천황 승계와 보신전쟁은 각각 인물 생애·정치 전환의 담당 체계를 정한 뒤 통합한다.
