...
- 임무 선택 사건 `.11/.12`에 있던 인물 충성도 즉시 보너스 32개를 제거했다. 영지 감독은 월간 L −0.1 / I −0.5, 충성심 재확인은 월간 L +0.5로 연결했다. 교토 선택지를 추가하고 기존 임무를 정리한 뒤 새 임무를 배치한다. 같은 지역·같은 종류의 임무 중복 배치를 제한했다.
